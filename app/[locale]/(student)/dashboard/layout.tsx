...
export default async function DashboardLayout({
  ...
  if (!profile) {
    // Do NOT redirect here. This is a Server Component — it can't clear the
    // session cookie, so redirecting to /login just restarts the loop with
    // middleware. Show a dead-end instead; the real fix is making sure this
    // query can actually find/read the row (see the Supabase SQL fix).
    return (
